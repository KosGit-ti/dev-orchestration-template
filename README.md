...
>
> **モードの使い方**: [docs/MODE_GUIDE.md](docs/MODE_GUIDE.md) に、3つの動作モード（自動実行／計画修正／汎用リクエスト）の選び方・使い方をまとめています。
>
> **テンプレートの更新**: [docs/UPGRADE_GUIDE.md](docs/UPGRADE_GUIDE.md) に、テンプレートのアップデート手順をまとめています。
